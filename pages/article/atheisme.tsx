                ...
                <article>
                    ...
                    <section>
                        ...
                        <ol>
                            ...
                            <li>Est <strong>athée négatif (ou faible)</strong> celui qui considère l'affirmation <i>"Il est nécessaire qu'au moins un être suprême existe"</i> comme fausse. C'est l'athée qui considère qu'un être suprême est une notion superflue pour expliquer notre univers, sans pour autant rejetter la possibilité d'une telle entité.</li>
                            <li>Est <strong>athée positif (ou fort)</strong> celui qui considère l'affirmation <i>"Au moins un être suprême existe"</i> comme fausse. C'est l'athéisme le plus fort, l'existence même d'un être suprême est rejettée.</li>
                        </ol>
                    </section>
                    <section>
                        ...
                        <p>Le plus petit dénominateur commun entre toutes les définitions d'athée vue jusqu'ici est le rejet de la croyance en un dieu d'une religion révélèe. Si je ne me reconnais dans aucun théisme, je suis athée. Jésus n'est pas mon sauveur, je ne me soumets pas à Allah, Jéhovah très peu pour moi, Bouddha n'en parlons pas, Odin, Osiris, Zeus, Amateratsu, Vishnu, ...</p>
